...
detect and recognise multi faces in camera or webcam with trained model (vgg16)

DataCreator : with tis code you can create dataset with your own face or other faces from webcam and images
...
create model: in this code i craete vgg16 model and three layes at top that you can create model and save it from your dateset.
you can change layers and number of classes and set path of dataset

facial recogniton: in this code you can use youe created model and detect and recognize multi faces and save them in history file with format '*.csv' .
